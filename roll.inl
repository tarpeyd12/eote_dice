...
namespace eote
{
    ...
    DieValues
    RollDice( const list_type& l )
    {
        return RollDice( l.begin(), l.end() );
    }

    template < typename iterator_type >
    DieValues
    RollDice( const iterator_type& begin, const iterator_type& end )
    {
        DieValues out;
        ...
        for( auto it = begin; it != end; ++it )
        {
            switch( *it )
            {
                case Roll::Blue:   out += Roll::_Blue();   break;
                case Roll::Black:  out += Roll::_Black();  break;
                case Roll::Red:    out += Roll::_Red();    break;
                case Roll::Yellow: out += Roll::_Yellow(); break;
                case Roll::Green:  out += Roll::_Green();  break;
                case Roll::Purple: out += Roll::_Purple(); break;
                case Roll::White:  out += Roll::_White();  break;
            }
        }
        return out;
    }
